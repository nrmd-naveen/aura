        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-10 mt-4 md:my-6">
            <div className="relative">
              <label className=" block my-2 md:my-3 md:ml-6">
                Select Service
              </label>
              <select
                {...register("service")}
  ...
  return (
    <>
      <div class="fixed top-4 right-4 z-50">
        <div class="bg-white border border-gray-300 text-gray-800 px-4 py-3 rounded shadow-lg w-72">
          <strong class="font-semibold">Submited successfully! </strong>
          <span class="block "> your enquiry has been sent </span>
        </div>
      </div>
    </>
  );
