function HeaderHeadings() {
  return (
    <>
          <div className="flex flex-col gap-2 md:gap-6 justify-center items-center mt-28 md:mt-16 w-full text-gray-txt font-league text-nowrap ">
    <div>            
  ...
  <div className="flex justify-center items-center w-full text-[40px] sm:text-6xl md:text-[86px]">
    ...
    <p className="font-extrabold Spartan ">
      digital services
    </p>
  </div>
</div>
